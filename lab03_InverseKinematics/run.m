...
%program_position2(:,1)=interp1(1:length(program_position(:,1)),...
%                              program_position(:,1),...
%                              linspace(1,length(program_position(:,1)),100));
%
%program_position2(:,2)=interp1(1:length(program_position(:,2)),...
%                              program_position(:,2),...
%                              linspace(1,length(program_position(:,2)),100));

%program_position=program_position2;
